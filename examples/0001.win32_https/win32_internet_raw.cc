...
int main()
{
	auto session(fast_io_examples::win32_internet_open("Microsoft Internet Explorer",INTERNET_OPEN_TYPE_PRECONFIG,nullptr,nullptr,0));
	auto connection(fast_io_examples::win32_internet_connect(session,"www.google.com",443,nullptr,nullptr,INTERNET_SERVICE_HTTP,0,0));
	auto request(fast_io_examples::win32_http_open_request(connection,"GET","index.html",HTTP_VERSION,nullptr,nullptr,
